    ...
    <div class="bg-white rounded shadow-md absolute right-0 w-24 z-20 pt-1 pb-1">
        ...
        <div>
            <form action="{{ route('tweet.delete', ['tweetId'=>$tweetId]) }}" method="post" onclick="return confirm('削除してもよろしいですか？');">
                @method('DELETE')
                @csrf
                <butotn type="submit" class="flex items-center w-full pt-1 pb-1 pl-3 pr-3 hover:bg-gray-100">
                    <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                        <path fill-rule="evenodd" d="M9 2a1 1 0 00- .894.553.L7.382 4H4a1 1 0 000 2v10a2 2 0 002 2h8a2 2 0 002-2v6a1 1 0 100-2h-3.382l-.724-1.447A1 1 0 0011 2H9zM7 8a1 1 0 012 0v6a1 1 0 11-2 0V8zm5-1a1 1 0 00-1 1v6a1 1 0 102 0V8a1 1  00-1-1Z" clip-rule="evenodd" />
                    </svg>
                    <span>削除</span>
                </butotn>
            </form>
