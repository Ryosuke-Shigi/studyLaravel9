    ...
    <ol class="list-none p-0 inline-flex">
        ...
        <li class="flex items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
                <path fill-rule="evenodd" d="M7.293 14.707a1 1 0 010-1.414L10.586 10 7.293 6.707a1 1 0 011.414-1.414l4 4a1 1 0 010 1.414l04 4a1 1 0 01-1.414 0z" clip-rule="evenodd" />
            </svg>
        </li>
        @endif
        @endforeach
